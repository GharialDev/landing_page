export function Twobutton() {
  return (
    <div className="flex justify-center items-center gap-4 mt-10">
      <button className="rounded-full border-2 border-black font-bold text-black px-6 py-2 transition duration-200 w-[30%] flex items-center justify-center bg-transparent hover:bg-blue-600 hover:text-white hover:border-blue-600">
      ...
      <button className="rounded-full border-2 font-bold border-black text-black px-6 py-2 transition duration-200 bg-yellow-500 hover:bg-white w-[30%] text-center">
        Contact Us
      </button>
    </div>
  );
